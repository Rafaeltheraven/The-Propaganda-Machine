...
ChangeLog.txt - A history of changes in this and earlier @game.name@ version
BugTrack.txt  - A list of known bugs and sugestions people have made

The full source to Risk is included in src.zip

@game.name@ is under the GNU General Public License, see gpl.txt for more details.
