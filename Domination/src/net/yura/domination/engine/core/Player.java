...
public class Player implements Serializable {
    ...
    private Vector<Country> initialCountries;
    ...
    public void addInitialCountries(Country country) {
        this.initialCountries.addElement(country);
    }

    public Vector getInitialCountries() {
        return this.initialCountries;
    }
